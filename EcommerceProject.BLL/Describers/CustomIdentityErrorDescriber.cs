...
namespace EcommerceProject.BLL.Describers
{
	public class CustomIdentityErrorDescriber:IdentityErrorDescriber
	{
		public override IdentityError PasswordRequiresUniqueChars(int uniqueChars)
		{
			return new IdentityError { Code = "PasswordRequiresUniqueChars", Description = $"Şifre en az {uniqueChars} benzersiz karakter içermelidir." };
		}
		public override IdentityError DuplicateEmail(string email)
		{
			return new IdentityError { Code = "DublicateEmail", Description = $"Bu email {email} adresine ait bir hesap sistemde mevcut." };
		}
		public override IdentityError DuplicateUserName(string userName)
		{
			return new IdentityError { Code = "DuplicateUserName", Description = $"Bu email {userName} adresine ait bir hesap sistemde mevcut." };
		}
		public override IdentityError DuplicateRoleName(string role)
		{
			return new IdentityError { Code = "DublicateRoleName", Description = $"Bu rol {role} ismi sistemde mevcut." };
		}
		...
		{
			return new IdentityError { Code = "ConcurrencyFailture", Description = "Birden çok kullanıcı aynı veriyi değiştirmeye çalıştı! Değişiklikler geri alınıyor!" };
		}
		...
		{
			return new IdentityError { Code = "UserAlreadyHasPassword", Description = "Kullanıcının sisteme kayıtlı parolası mevcut." };
		}
